...
public final class IDWBenchmark_benchmarkAtualizarVizinhos_jmhTest {
    ...
    public BenchmarkTaskResult benchmarkAtualizarVizinhos_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                ...
                blackhole.consume(l_idwbenchmark0_0.benchmarkAtualizarVizinhos(l_estadodobenchmark1_G, blackhole));
            ...
            benchmarkAtualizarVizinhos_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_estadodobenchmark1_G, l_idwbenchmark0_0);
    ...
    public BenchmarkTaskResult benchmarkAtualizarVizinhos_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            benchmarkAtualizarVizinhos_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_estadodobenchmark1_G, l_idwbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult benchmarkAtualizarVizinhos_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            benchmarkAtualizarVizinhos_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_estadodobenchmark1_G, l_idwbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult benchmarkAtualizarVizinhos_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            benchmarkAtualizarVizinhos_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_estadodobenchmark1_G, l_idwbenchmark0_0);
            control.preTearDown();
