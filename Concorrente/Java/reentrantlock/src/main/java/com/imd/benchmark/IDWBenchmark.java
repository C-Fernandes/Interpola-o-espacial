...
public class IDWBenchmark {
    ...
    @Benchmark
    public void benchmarkProcessarLote(EstadoDoBenchmark estado, Blackhole bh) throws IOException {
        ...
        try (
                BufferedWriter bw = new BufferedWriter(
                        new FileWriter("saida_interpolacao.txt"))) {
            estado.leitor.processarLote(estado.dataParaLoteBenchmark, alvosParaLote, validosParaLote, bw);
        }
