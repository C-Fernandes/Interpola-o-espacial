...
public class LeitorCSV {
    ...
    private void processaEDisparaGravacao(
        ...
        // Usamos a mesma lógica de CompletionService, mas levando em conta que cada
        // submit
        // roda em Virtual Thread.
        ExecutorCompletionService<String> completionService = new ExecutorCompletionService<>(executor);

        // 1) Submete todas as tarefas de interpolação (uma Virtual Thread por tarefa)
        ...
        // 2) Coleta os resultados à medida que ficam prontos
        ...
        // 3) Submete gravação em uma Virtual Thread também
        executor.submit(() -> {
